...
const DUMMY_ATS = [
  {
    memo: '通過（男性44歳・現職・営業）',
    name: '田中 一郎', kana: 'たなか いちろう', gender: '男性',
  ...
  {
    memo: '通過（女性54歳・現職・営業）',
    name: '佐藤 花子', kana: 'さとう はなこ', gender: '女性',
  ...
  },
  {
    ...
    name: '鈴木 次郎', kana: 'すずき じろう', gender: '男性',
  ...
  {
    memo: '除外（氏名がカタカナのみ）',
    name: 'グエン バン', kana: 'ぐえん ばん', gender: '男性',
  ...
  {
    memo: '学生（在学中）',
    name: '高橋 美咲', kana: 'たかはし みさき', gender: '女性',
