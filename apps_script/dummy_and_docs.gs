...
function createReadmeSheet() {
  ...
  const lines = [
    ...
    ['', '　経験の種類…頭の【　】がご経験の区分です'],
    ['', '　　　【営業】【コールセンター】【販売・接客】'],
    ['', '　　　続けて、アンケートでお選びいただいた内容が入ります'],
    ['', '　　　求人ボックス経由の方は職務経歴から該当箇所を入れています'],
    ...
    ['', '・営業またはコールセンターのご経験があり、'],
    ['', '　「新規開拓（アウトバウンド）」を選択された方'],
    ['', '　※問い合わせ対応（インバウンド）のみ、既存営業のみの方は対象外です'],
    ['', '・販売または接客のご経験があり、個人目標をお持ちだった方'],
    ['', ''],
    ['求人ボックス経由', '職務経歴に営業またはコールセンターのご経験がある方'],
    ['', '※営業事務・営業アシスタントは対象外としています'],
    ['', ''],
    ...
    ['', '職種の分類は仮の名称です。貴社の呼び方に合わせて変更いたします'],
    ['', ''],
...
const TEST_ATS = [
  { memo: '通過（男44・新規開拓）', name: '田中 一郎', kana: 'たなか いちろう',
    ...
    form: { 経験: '営業', 種類: '新規開拓（テレアポなどアウトバウンドの営業やコールセンター業務）, 既存営業', 年数: '3年以上' } },
  ...
  { memo: '通過（男41・新規開拓）', name: '森 大輔', kana: 'もり だいすけ',
    ...
    form: { 経験: 'コールセンター', 種類: '新規開拓（テレアポなどアウトバウンドの営業やコールセンター業務）', 年数: '3年以上' } },
  ...
  { memo: '除外（インバウンドのみ）', name: '渡辺 健二', kana: 'わたなべ けんじ',
    ...
    form: { 経験: '営業', 種類: '新規問い合わせ（問い合わせ対応などインバウンドの営業やコールセンター業務）, 既存営業', 年数: '3年以上' } },
  ...
  { memo: '除外（女54・年齢超過）', name: '佐藤 花子', kana: 'さとう はなこ',
    ...
    form: { 経験: '営業', 種類: '新規開拓（テレアポなどアウトバウンドの営業やコールセンター業務）', 年数: '3年以上' } },
  ...
  { memo: '除外（在学中）', name: '高橋 美咲', kana: 'たかはし みさき',
    ...
    form: { 経験: '営業', 種類: '新規開拓（テレアポなどアウトバウンドの営業やコールセンター業務）', 年数: '1年未満' } },
